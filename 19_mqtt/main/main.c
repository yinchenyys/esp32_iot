...
#define MQTT_USERNAME   "yys"                     //MQTT用户名
#define MQTT_PASSWORD   "12345678"                  //MQTT密码(￥不对也能连接)

#define MQTT_PUBLIC_TOPIC      "/topic/esp"       //测试用的,推送消息主题
#define MQTT_SUBSCRIBE_TOPIC    "/topic/mqtt"      //测试用的,需要订阅的主题
